          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                <div className="gap-2">
                  <h1 className="mb-5 text-2xl font-bold leading-tight text-black sm:text-3xl sm:leading-tight md:text-3xl md:leading-tight">
                    Learn Software Development and Data Skills from Experts.
                ...
                <div className="flex justify-center items-center bg-white rounded-md  w-full h-auto">
                  <img
