...
const CourseModuleParts = () => {
    ...
    useEffect(() => {
        const getModuleParts = async() => {
            const response = await fetch(`${BACKEND_URL}/courses/course-module-parts/${id}`, {
                method: "GET",
                headers: {
            ...
            <table className="assignments-table">
                ...
                <tbody>
                    {moduleParts.map((module, index) => (
                        ...
                        <td><a href={`/course-topics/${module._id}`} className='btn btn-info btn-sm'>View Details</a></td>
                    </tr>
                    ))}
