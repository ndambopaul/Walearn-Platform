...
const GradeDetails = ({ grade }) => {
  ...
  return (
    <>
    <button className='btn btn-primary btn-sm' onClick={() => setOpenModal(true)} data-bs-toggle='modal' data-bs-target='#gradeDetailsModal'><IoEyeOutline /></button>
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-body">
        <p><b>Course:</b> {grade?.course.title}</p>
        <p><b>Assignment:</b> {grade.assignment.title}</p>
        <p><b>Marks:</b> {grade.grade}</p>
